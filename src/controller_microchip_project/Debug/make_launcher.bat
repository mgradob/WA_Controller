...
@REM   i.e.   ${workspace_loc:System_Exp_03_28_14}/make_launcher.bat
...
@set ERIKA_FILES=C:\Programmi\Evidence\eclipse\plugins\com.eu.evidence.ee_2.1.0.20130515_1228\ee_files
